...
public class CameraWrapper {
    ...
    public void nullifyCamera(){
        mNativeCamera.nullifyCamera();
    }

    public void openCamera(boolean isFrontCamera) throws OpenCameraException {
        try {
            mNativeCamera.openNativeCamera(isFrontCamera);
